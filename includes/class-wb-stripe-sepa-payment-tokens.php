 ...
 * @since    4.0.0
 */
class WB_Payment_Token_SEPA extends WC_Payment_Token {
	...
	public function get_last4( $context = 'view' ) {
		return WB_Stripe_Helper::is_wc_lt( '3.0' ) ? $this->get_meta( 'last4' ) : $this->get_prop( 'last4', $context );
	}
	...
	public function set_last4( $last4 ) {
		WB_Stripe_Helper::is_wc_lt( '3.0' ) ? $this->add_meta_data( 'last4', $last4, true ) : $this->set_prop( 'last4', $last4 );
	}
}
