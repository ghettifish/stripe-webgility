...
return apply_filters(
	...
	array(
		'enabled'                       => array(
			...
			'label'       => __( 'Enable Webgility Stripe', 'woocommerce-gateway-stripe' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		),
		...
		'description'                   => array(
			...
			'default'     => __( 'Pay with your credit card via Stripe. Your card will be billed the full amount after your invoice has been completed.', 'woocommerce-gateway-stripe' ),
			'desc_tip'    => true,
		),
		'webhook'                       => array(
